...
// Acceder a la variable de sesión del rango
if (isset($_SESSION['id_rol'])) {
    $idRol = $_SESSION['id_rol'];
    echo "El rol del usuario es: " . $idRol;
} else {
    echo "No se ha iniciado sesión o la sesión ha expirado.";
}
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                                ...
                                <?php if ($idRol == 1) {
                                    ...
                                    ?>
                                    <li><a class="dropdown-item" href="controlador.php?seccion=seccion6">Lista De Usuarios</a>
                                    </li> <?php
                                } ?>
